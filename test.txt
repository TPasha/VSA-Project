...
namespace Splitting
{
    class Program
    {
        ...
        {
            string[] words1 = EatWhiteChar(FromSource("f:\\oku.txt"));
            string[] words2 = EatWhiteChar(FromSource("f:\\test.txt"));
            ...
            Console.WriteLine(CosineSimilarity(tables[0], tables[1]));
        ...
        {
            StreamWriter wrt = new StreamWriter("c:\\Test.txt");
